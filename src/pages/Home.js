  ...
  return (
    ...
    <main className="h-full bg-wrinkledpaper" >
      ...
      <div className="xl:max-w-lg xl:ml-auto">
        <img className="mt-6 rounded-lg shadow-xl sm:mt-8 sm:w-full sm:object-cover sm:object-center lg:hidden" src="images/y2k-newsletter-photo.jpg" alt="model curly hair and hawaiian patterned top"/>
