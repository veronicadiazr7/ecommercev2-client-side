          ...
          <div className="w-72 h-auto bg-slate-300 shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
            <Link >
              ...
              <div className="px-4 py-3 w-72 bg-yellow-300">
                <span className="text-gray-900 mr-3 uppercase text-md">{product.category}</span>
                <p className="text-xl font-bold text-black truncate block capitalize">{product.name}</p>
                <div className="flex items-center">
                  <p className="text-xl font-semibold text-black cursor-auto my-3">${product.price}</p>
                  <div className="ml-auto"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-bag-plus" viewBox="0 0 16 16">
